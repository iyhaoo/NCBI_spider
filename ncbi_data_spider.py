        ...
        def ftp_callback(self):
            ...
            if len(run_info["cache"]) >= run_info["cacheLen"] or run_info["finLen"] + len(run_info["cache"]) >= run_info["dataLen"]:
                ...
                print("wrinting {}\t{:.2%}\tSpeed: {}k/s"
                      .format(file_path,
                              run_info["finLen"] / run_info["finLen"],
...
output_dir = "E:/single_cell_data/ncbi_spider_20180820"
allDatasets = ["GSE98561", "GSE108097", "SRP095350", "GSE99866"]
#just_summary = True
just_summary = False
#
#
...
>>>>>>> 649b7e9be36fdeaa22035ae9ff36dd9d6234184d
